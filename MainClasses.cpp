...
/*
Code created by: Gregory Feng
Creates a database for Media types: Music, Movies, and Videogames and allows the user to manipulate the database
by giving them the ability to add a media array, search for a media array, or delete a media array.
 */
using namespace std;
